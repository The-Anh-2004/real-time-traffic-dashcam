Real-Time Traffic Dashcam Detection
This project uses the YOLOv8 model to detect and recognize traffic signs from dashcam video in real time. 

The system is packaged and deployed using Docker, and simulates a Raspberry Pi 4 environment to evaluate the ability to run a Computer Vision model on resource-limited edge computing devices. 
